...
- Distinct `.btn-kuruma` style required: solid KurumaWorks blue (#2663eb) fill / white text at rest, darkening fill and border to #1e4db7 on hover (text stays white). Must look visually distinct from the site's own brand color everywhere else.
